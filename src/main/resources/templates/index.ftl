...
<div class="container">
    ...
    <div align="center" id="header" class="section">
        <img alt="" class="img-circle" width="215" height="200"
             src="http://i.piccy.info/i9/ecc5c37c5d2959c4b6046d9386b4bdc0/1526979635/122760/1246012/DSC_7501.jpg">
    ...
    <div class="section">
        ...
        <p>
            ...
            документация и огромное сообщество, готовое помочь советом в трудную минуту. Еще я полюбил
            <strong>Java</strong>
            за его универсальность. Вчера ты писал десктопные программы, сегодня игры и приложеня для телефонов и
            планшетов,
    ...
    <div class="section">
        ...
        <p>
            ...
            Правда, тогда его функционал был скуден, и разрабатывался он как приложения для Android. Сейчас же это
            web-приоложение.
            Суть приложения не нова. Это что-то наподобие социальной сети для студентов. В базе хранится список
            университетов.
            Учитель выбирает свой университет, и создает группу. У группы есть список студентов, расписание группы,
            дисциплины.
            Также у каждой группы есть своя "стена", где каждый участник группы может публиковать сообщения. Стена видна
            всем
            участникам группы.
        <p>Учитель вправе добавлять или удалять студентов из группы, удалять сообщения со стены. Также ему доступен
            список всех
            участников группы с подробной информацией о каждом (адрес, телефон, оценки).
        </p>
        <p>
            Студент же может после регистрации выбрать свой университет, группу и отправить заявку на вступление. После
            одобрения
            заявки учителем группы студент становится ее участником. Он может видеть стену группы, оставлять сообщения
            не ней, ему доступно
        ...
        <p>
            Исходный код проекта можно посмотреть на <a href="https://github.com/ArtPreD/Project-Grouper">GitHub</a>.
            Так как у Gruoper'a есть иерархия прав
            (студент, учитель), то при создании пользователя будет установлен статус "сутдент". Чтобы посмотреть, что
            доступно
